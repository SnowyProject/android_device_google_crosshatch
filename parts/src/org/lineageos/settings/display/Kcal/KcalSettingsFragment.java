...
public class KcalSettingsFragment extends PreferenceFragment implements
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        switch (preference.getKey()){
            case "kcal_enable":
                KcalUtils.writeConfigToNode(KcalUtils.KCAL_ENABLE_NODE, 0, (Boolean) newValue ? 0 : 1);
                break;
            case "red_slider":
                KcalUtils.writeConfigToNode(KcalUtils.KCAL_R_NODE, 0, (Integer) newValue);
                mRedColorSlider.setSummary(String.valueOf(newValue));
                break;
            case "green_slider":
                KcalUtils.writeConfigToNode(KcalUtils.KCAL_G_NODE, 0, (Integer) newValue);
                mGreenColorSlider.setSummary(String.valueOf(newValue));
                break;
            case "blue_slider":
                KcalUtils.writeConfigToNode(KcalUtils.KCAL_B_NODE, 0, (Integer) newValue);
